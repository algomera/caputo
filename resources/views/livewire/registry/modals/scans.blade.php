<div class="px-14 py-8 flex flex-col">
    ...
    <div class="flex items-end justify-between">
        ...
        <button wire:click="$set('modify', true)" class="px-4 py-1 text-color-2c2c2c font-medium capitalize rounded-full bg-color-01a53a/30 hover:scale-105 transition-all duration-300">Aggiungi scansioni</button>
    </div>
