<div class="p-5 flex flex-col gap-5 items-center justify-center">
    ...
    @if (!str_contains($scan->type,'firma'))
        <object data="{{ asset($scan->path) }}" type="application/pdf" width="100%" height="600px"></object>
    @else
        <object data="{{ asset($scan->path) }}" type="application/pdf" width="100%" height="300px"></object>
    @endif
